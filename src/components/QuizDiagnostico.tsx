...
const AREAS: Record<Area, { nombre: string; consejo: string; href: string; enlace: string }> = {
    ...
    ia: {
        ...
        consejo: "El Reglamento de IA ya aplica, y desde agosto de 2026 las autoridades nacionales lo supervisan. La formación con certificados y registro es la medida más razonable por la que empezar — y de paso el equipo aprende a usarla bien.",
