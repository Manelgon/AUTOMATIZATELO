...
- [Automatización para empresas de servicios](https://automatizatelo.com/sistemas): CRM y seguimiento automático de leads
...
- [Auditoría IA · cumplimiento del AI Act](https://automatizatelo.com/cumplimiento): revisión del uso de IA en la empresa, informe de riesgos, plan de acción, política de uso de IA y formación del art. 4; diagnóstico desde 750 €, pack completo desde 1.800 €
- [Implantación de herramientas IA](https://automatizatelo.com/cumplimiento): puesta en marcha de ChatGPT, Microsoft Copilot o Gemini en la empresa — elección sin comisiones, configuración segura, casos de uso por puesto; desde 900 €
- [Implantación de CRM](https://automatizatelo.com/sistemas/crm): elección sin comisiones (HubSpot, Pipedrive, Zoho o a medida), configuración, migración de datos y automatizaciones para que se rellene solo; desde 900 €
- [Automatización de procesos](https://automatizatelo.com/sistemas): facturas y documentos sin picar datos (y generación automática de los tuyos), seguimiento de clientes, avisos y reportes automáticos
- [Chatbots de WhatsApp y web](https://automatizatelo.com/sistemas/chatbots-whatsapp): bots conectados a la agenda, CRM o catálogo de la empresa, con escalado a persona; dentro de proyectos desde 2.000 €
- [Chatbot de WhatsApp (API oficial)](https://automatizatelo.com/sistemas/chatbots-whatsapp): citas, avisos y dudas 24/7 en WhatsApp Business API — número verificado, plantillas aprobadas, sin riesgo de bloqueo; el bot se identifica como IA (art. 50)
...
- [Curso de Claude para empresas](https://automatizatelo.com/formacion/claude): documentos largos, redacción profesional y agentes — impartido por un usuario diario real de la herramienta; desde 900 €
- [Formación obligatoria del AI Act (art. 4)](https://automatizatelo.com/formacion/ai-act): qué exige el artículo 4 del Reglamento Europeo de IA, desde cuándo aplica (feb-2025), sanciones y cómo acreditar el cumplimiento en una pyme
- [Casos de éxito](https://automatizatelo.com/casos): sistemas reales en producción, con detalle de problema, solución y resultados
