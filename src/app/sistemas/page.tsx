...
export default function AutomatizacionPage() {
    return (
        <main style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
            ...
            <section id="documentos" style={{ padding: "4.5rem 0", background: "linear-gradient(135deg, #b45309 0%, #7c2d12 55%, #431407 100%)" }}>
            ...
            <section style={{ padding: "4.5rem 0", background: "var(--color-bg-secondary)", borderTop: "1px solid var(--color-border)", borderBottom: "1px solid var(--color-border)" }}>
                <div className="container">
                    ...
                    <div className="au-hub">
                        {[
                            { href: "/sistemas/chatbots-whatsapp", icon: "fa-comment-dots", t: "Chatbots — WhatsApp y web", d: "Atención 24/7 con API oficial, conectada a tus sistemas y con escalado a persona." },
                            { href: "/sistemas/integracion", icon: "fa-diagram-project", t: "Integración de sistemas", d: "Tus herramientas pasándose los datos solas: CRM, facturación, correo, Excel." },
                            { href: "/sistemas/documentos", icon: "fa-file-import", t: "Facturas y documentos", d: "Los que llegan se leen solos; los tuyos se generan solos. La sección estrella." },
                            { href: "/sistemas/ventas", icon: "fa-arrow-trend-up", t: "Automatización de ventas", d: "Del lead al cobro: respuesta inmediata, seguimiento y facturación solos." },
                            { href: "/sistemas/crm", icon: "fa-address-book", t: "CRM que se alimenta solo", d: "Elegido sin comisiones, migrado, y con automatizaciones que lo mantienen vivo." },
                            { href: "/sistemas/paneles", icon: "fa-chart-line", t: "Paneles a medida", d: "Tu negocio entero en una pantalla, integrado con lo que ya usas." },
                            { href: "/cumplimiento", icon: "fa-clipboard-check", t: "Cumplimiento del AI Act", d: "Antes de automatizar con IA, saber si tu empresa cumple — y dejarlo cerrado." },
                        ].map((p) => (
                            <Link key={p.t} href={p.href} className="au-hub-item">
