...
export default function IntegracionSistemasPage() {
    return (
        <main style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
            ...
            <nav aria-label="Casos concretos" className="in2-tira">
                <div className="container in2-tira-fila">
                    <span className="in2-tira-etiqueta mono-label">¿Tu caso es más concreto?</span>
                    {[
                        ...
                        <Link key={t.href} href={t.href} className="in2-tira-item">
                            <span className="in2-tira-num">{String(i + 1).padStart(2, "0")}</span>
                            {t.label}
                        </Link>
                    ))}
                </div>
            ...
            <style>{`
                ...
                .in2-tira-item:hover { color: #faf6ef; background: rgba(250, 246, 239, 0.05); }
                .in2-tira-num { color: #f6c39c; font-size: 0.7rem; opacity: 0.75; }
                @media (max-width: 900px) {
                    .in2-tira-item { flex: 1 1 45%; justify-content: flex-start; }
                }
                .in2-con-grid {
                    display: grid;
