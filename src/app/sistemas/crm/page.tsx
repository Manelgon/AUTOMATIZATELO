...
export default function ImplantacionCrmPage() {
    return (
        <main style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
            <Esquema datos={migas([{ nombre: "Automatización y sistemas", url: "/sistemas" }, { nombre: "CRM", url: "/sistemas/crm" }])} />
            ...
            <section style={{ padding: "4rem 0", background: "#1c1917" }}>
                <div className="container cr2-faq-grid">
                    <div>
                        ...
                        <Link href="/casos" className="cr2-enlace" style={{ marginTop: "0.9rem", display: "inline-block" }}>Ver un CRM a medida en producción →</Link>
                    </div>
                    <div>
                        {faqs.map((f) => (
