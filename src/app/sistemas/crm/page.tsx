...
export default function ImplantacionCrmPage() {
    return (
        <main style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
            ...
            <nav aria-label="Casos concretos" className="cr2-tira">
                <div className="container cr2-tira-fila">
                    <span className="cr2-tira-etiqueta mono-label">¿Tu caso es más concreto?</span>
                    {[
                        ...
                        <Link key={t.href} href={t.href} className="cr2-tira-item">
                            <span className="cr2-tira-num">{String(i + 1).padStart(2, "0")}</span>
                            {t.label}
                        </Link>
                    ))}
                </div>
            ...
            <style>{`
                ...
                .cr2-tira-item:hover { color: #faf6ef; background: rgba(250, 246, 239, 0.05); }
                .cr2-tira-num { color: #f6c39c; font-size: 0.7rem; opacity: 0.75; }
                @media (max-width: 900px) {
                    .cr2-tira-item { flex: 1 1 45%; justify-content: flex-start; }
                }
                .cr2-herr-grid {
                    display: grid;
