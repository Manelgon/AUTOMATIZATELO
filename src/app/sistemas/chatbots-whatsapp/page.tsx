...
export const metadata: Metadata = {
    ...
    description:
        "Chatbots en WhatsApp (API oficial) y en tu web: citas, avisos y dudas resueltas 24/7, conectados a tu sistema. Desde 3.000 €.",
...
const faqs = [
    ...
    },
    {
        ...
        answer: "El bot forma parte de un proyecto de automatización desde 3.000 €, porque su valor está en conectarlo a tu agenda o tu sistema — un bot que no consulta nada solo contesta bonito. Aparte están las tarifas de conversación de Meta, que son céntimos y se pagan directamente a Meta: sin sobreprecio ni comisión mía, como todo lo que hago.",
    },
    {
...
const serviceJsonLd = {
    ...
    "areaServed": "España",
    "description": "Chatbots de WhatsApp con la API oficial de WhatsApp Business: citas, avisos y dudas resueltas 24/7, conectados a los sistemas de la empresa y con escalado a persona. Dentro de proyectos desde 3.000 €.",
};
...
export default function ChatbotsWhatsappPage() {
    return (
        <main style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
            <Esquema datos={migas([{ nombre: "Automatización y sistemas", url: "/sistemas" }, { nombre: "Chatbots y WhatsApp", url: "/sistemas/chatbots-whatsapp" }])} />
                    ...
                    <div className="cw2-mitad">
                        ...
                        <div className="cw2-cuerpo">
                            ...
                            <div className="cw2-datos">
                                ...
                                <span className="cw2-dato-precio">Dentro de proyectos desde 3.000 €</span>
                            </div>
                ...
                <div className="container">
                    <div className="cw2-cifras">
                        <div className="cw2-cifra">
                            <span className="cw2-cifra-num">desde 3.000 €</span>
