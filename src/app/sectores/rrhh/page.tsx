...
const props: SectorPageProps = {
    ...
    sectorSlug: "automatizacion-reclutamiento-rrhh",
    icon: "fa-user-tie",
    color: "#10b981",
    ...
    results: [
        ...
        { stat: "100%", label: "De candidatos con respuesta, sin excepción" },
    ...
    faqs: [
        ...
        { question: "¿La IA decide qué candidatos pasan? ¿Eso es legal?", answer: "La IA preclasifica y ordena; la decisión es siempre de una persona — y así queda registrado. El Reglamento Europeo de IA considera la selección de personal un ámbito de alto riesgo precisamente cuando la máquina decide sola, por eso el sistema se diseña con supervisión humana y trazabilidad desde el primer día." },
    ...
    relacionados: [
        { href: "/cumplimiento", icon: "fa-clipboard-check", titulo: "Auditoría IA (AI Act)", desc: "La selección de personal es ámbito sensible del Reglamento: conviene tenerlo por escrito. Desde 750€." },
        ...
        { href: "/formacion", icon: "fa-graduation-cap", titulo: "Formación en IA", desc: "Que tu equipo use la IA con criterio — y con los datos de los candidatos a salvo." },
