...
const props: SectorPageProps = {
    ...
    sectorSlug: "sectores/administradores-fincas",
    icon: "fa-building",
    color: "#0ea5e9",
    ...
    opcionesFormulario: [
        "Registrar y seguir incidencias",
        "Comunicaciones con vecinos",
        "Documentación por comunidad",
        "Un panel para todo el despacho",
    ...
    faqs: [
        ...
        { question: "¿Cuánto cuesta?", answer: "Una automatización concreta (por ejemplo, el registro de incidencias) desde 500 €. Un panel de gestión completo para el despacho, desde 3.000 €. Pide la auditoría gratuita y te decimos qué recuperarías primero." },
    ],
    relacionados: [
        { href: "/sectores/despachos", icon: "fa-briefcase", titulo: "Formación en IA para despachos", desc: "Que el equipo use la IA sin jugarse los datos de los propietarios. Desde 750 €." },
        ...
        { href: "/cumplimiento", icon: "fa-clipboard-check", titulo: "Auditoría IA (AI Act)", desc: "Un despacho que asesora en cumplimiento no puede incumplir. Desde 950 €." },
...
export default function Page() {
    return (
        <>
            <Esquema datos={migas([{ nombre: "Administradores de fincas", url: "/sectores/administradores-fincas" }])} />
