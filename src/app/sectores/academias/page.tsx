...
const props: SectorPageProps = {
    ...
    relacionados: [
        { href: "/formacion", icon: "fa-clapperboard", titulo: "Producción de cursos SCORM", desc: "Amplía catálogo sin producirlo tú: guion, materiales y empaquetado, desde 1.900€." },
