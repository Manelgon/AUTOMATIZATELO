        ...
        <main style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
            ...
            <section style={{ padding: "4.5rem 0", background: "linear-gradient(135deg, #b45309 0%, #7c2d12 55%, #431407 100%)" }}>
                <div className="container" style={{ maxWidth: 900 }}>
                    ...
                    <p style={{ color: "rgba(250,246,239,0.85)", lineHeight: 1.7, marginTop: "2rem", maxWidth: 720 }}>
                        ...
                        <Link href="/formacion/ai-act" style={{ color: "#f6c39c", fontWeight: 600 }}>
                            Art. 4 del AI Act
                        </Link>.
                    </p>
                </div>
            ...
            <section style={{ padding: "4.5rem 0" }}>
                <div className="container" style={{ maxWidth: 1000 }}>
                    <div style={{ marginBottom: "2rem" }}>
                        <span className="kicker-mono">El formato que mejor funciona</span>
                        <h2 className="section-title" style={{ textAlign: "left", marginTop: "0.8rem", marginBottom: "0.5rem" }}>
                            Alfabetización IA + práctica de aula
                        </h2>
                        <p className="section-subtitle" style={{ textAlign: "left", margin: 0, maxWidth: 680 }}>
                            Dos sesiones para el claustro: la alfabetización obligatoria del Art. 4 para todo el personal, y un taller 100% práctico donde cada docente monta cosas para SU asignatura.
                        </p>
                    </div>
                    ...
                    <div className="ce-sesiones">
                        ...
                        <div className="ce-sesion ce-sesion-2">
                            ...
                            <h3>El aula, dominada</h3>
                            <p>Con las herramientas de verdad — los asistentes generalistas bien usados y las pensadas para docentes — y con los casos reales de vuestro centro.</p>
                            <div className="ce-herramientas">
                                <span className="ce-herr-titulo">Lo que cada docente se lleva montado</span>
                            <div className="ce-herr"><span>Preparar clases</span><span className="ce-punto">programaciones y materiales en la mitad de tiempo</span></div>
                            <div className="ce-herr"><span>Rúbricas y evaluación</span><span className="ce-punto">criterios claros en un mundo con ChatGPT</span></div>
                            <div className="ce-herr"><span>Adaptaciones por nivel</span><span className="ce-punto">la misma actividad, en tres dificultades</span></div>
                            <div className="ce-herr"><span>Corrección asistida</span><span className="ce-punto">la parte mecánica, fuera de las tardes</span></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="ce-datos">
                        <div className="ce-dato">
                            ...
                            <span className="ce-dato-sub">Adaptable al claustro y al calendario escolar</span>
                        </div>
                        <div className="ce-dato">
                            <span className="mono-label" style={{ color: "var(--color-primary)" }}>Cómo se imparte</span>
                            <strong>3 formatos</strong>
                            <span className="ce-dato-sub">Presencial · remoto en directo · e-learning (SCORM)</span>
                        </div>
                        <div className="ce-dato">
                            <span className="mono-label" style={{ color: "var(--color-primary)" }}>Acredita</span>
                            <strong>Certificado nominal</strong>
                            <span className="ce-dato-sub">Y registro formativo del Art. 4 para el centro</span>
                        </div>
                        <div className="ce-dato">
