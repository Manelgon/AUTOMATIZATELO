            ...
            faqs={[
                {
                    ...
                    answer: "Este taller es la parte práctica. Para cumplir el Art. 4 hace falta también el bloque de alfabetización (riesgos, marco legal, uso responsable) — juntos forman el curso estrella, desde 1.200€, con certificado nominal y registro formativo que sirven de evidencia. Si tu equipo ya tiene la alfabetización hecha, el taller suelto vale.",
                },
                {
