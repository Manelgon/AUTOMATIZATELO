            ...
            <section style={{ padding: "4rem 0", background: "var(--color-bg-secondary)", borderTop: "1px solid var(--color-border)", borderBottom: "1px solid var(--color-border)" }}>
                <div className="container" style={{ maxWidth: 900 }}>
                    ...
                    <p style={{
                        ...
                        Paneles de gestión a medida desde 2.000€: clientes, incidencias, agenda y
                        métricas en un solo sitio, integrados con lo que ya usas. Sin licencias por
                        usuario, y el código y los datos son tuyos.
                    </p>
